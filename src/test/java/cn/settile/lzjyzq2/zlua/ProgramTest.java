...
class ProgramTest {
    ...
    @Test
    void main_r_u() throws URISyntaxException, IOException {
        Program.main(new String[]{
                "-r",
                Paths.get(Objects.requireNonNull(getClass().getResource("/upvalue.out")).toURI()).toFile().getAbsolutePath()
        });
    }

    @Test
    void main_r_v() throws URISyntaxException, IOException {
        Program.main(new String[]{
                "-r",
    ...
    @Test
    void main_r_err() throws URISyntaxException, IOException {
        Program.main(new String[]{
                "-r",
                Paths.get(Objects.requireNonNull(getClass().getResource("/err.out")).toURI()).toFile().getAbsolutePath()
        });
    }
}